...
Research(research_id: INT[PK], user_id: INT [FK to User.user_id], age_filter: INT, sex_filter: VARCHAR(1), descent_filter: VARCHAR(1), station_filter: INT, weapon_filter: INT, crime_cd_filter: INT, latitude_filter: Decimal, longitude_filter: Decimal, notes: VARCHAR(560))
